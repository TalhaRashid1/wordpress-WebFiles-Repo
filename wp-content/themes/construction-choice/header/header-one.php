						    ...
						    <div class="quickcontact">
					            ...
					            if(!empty( $phone_number )) { ?>
				                	...
				                	<div class="get-tuch">
				                	    ...
				                	    <ul>
				                	        <li>
				                	            <h4><?php esc_html_e('Phone Number','construction-choice'); ?></h4>
				                	        </li>
				                	        <li>
				                	        	<p>
					            ...
					            <?php }  if(!empty( $map_address )) { ?>
				            		...
				            		<div class="get-tuch">
				            		    ...
				            		    <ul>
				            		        <li>
				            		            <h4><?php esc_html_e('Contact Address','construction-choice'); ?></h4>
				            		        </li>
				            		        <li>
					            ...
					            <?php }  if(!empty( $email_address )) { ?>
				            		...
				            		<div class="get-tuch">
				            		    ...
				            		    <ul>
				            		        <li>
				            		            <h4><?php esc_html_e('Email Address','construction-choice'); ?></h4>
				            		        </li>
				            		        <li>
				            		            <p>
	    ...
	    <div class="nav-wrapper nav-classic">
	    	<div class="container">
	    		<div class="row">
	    			<div class="col-md-8">
	    				<div class="nav-menu">
						<nav class="box-header-nav main-menu-wapper" aria-label="<?php esc_attr_e( 'Main Menu', 'construction-choice' ); ?>" role="navigation">
							<?php
								wp_nav_menu( array(
	    			...
	    			<div class="social_media_part">
	    				<?php construction_light_topheader_social(); ?>
	    			</div>
