    ...
    <div class="tab-sec">
		<div class="tab">
			...
			<button class="tablinks" onclick="automotive_centre_open_tab(event, 'block_pattern')"><?php esc_html_e( 'Setup With Block Pattern', 'automotive-centre' ); ?></button>
		  	...
		  	<button class="tablinks" onclick="automotive_centre_open_tab(event, 'product_addons_editor')"><?php esc_html_e( 'Woocommerce Product Addons', 'automotive-centre' ); ?></button>	  
		...
		<div id="product_addons_editor" class="tabcontent">
			...
			<?php }else{ ?>
				<h3><?php esc_html_e( 'Woocommerce Products Blocks', 'automotive-centre' ); ?></h3>
				<hr class="h3hr">
				<div class="automotive-centre-pattern-page">
					<p><?php esc_html_e('Follow the below instructions to setup Products Templates.','automotive-centre'); ?></p>
					<p><b><?php esc_html_e('1. First you need to activate these plugins','automotive-centre'); ?></b></p>
						<p><?php esc_html_e('1. Ibtana - WordPress Website Builder ','automotive-centre'); ?></p>
						<p><?php esc_html_e('2. Ibtana - Ecommerce Product Addons.','automotive-centre'); ?></p>
						<p><?php esc_html_e('3. Woocommerce','automotive-centre'); ?></p>

					<p><b><?php esc_html_e('2. Go To Dashboard >> Ibtana Settings >> Woo Settings','automotive-centre'); ?></span></b></p>
	              	<img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getstart/images/product-addon.png" alt="" />
	              	<div class="automotive-centre-pattern-page">
			    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-templates&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','automotive-centre'); ?></a>
			    	</div>
	              	<p><?php esc_html_e('You can create a template as you like.','automotive-centre'); ?></span></p>
			    </div>
			<?php } ?>
		</div>
