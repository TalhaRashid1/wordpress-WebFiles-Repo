jQuery(document).ready(function($) {
    'use strict';
    var this_obj = automotive_centre_plugin_activate_plugin;
    ...
    $(document).on('click', '.automotive-centre-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message automotive-centre-plugin-install');
                button.addClass('button-primary automotive-centre-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.automotive-centre-recommended-plugins .automotive-centre-activation-note').css('display','block');
    ...
    $(document).on('click', '.automotive-centre-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .automotive-centre-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .automotive-centre-recommended-plugins').css('display','none');
    });
